...
alias vrcu='vi /root/preconfig/.vimrc'
alias vrco='vi /root/preconfig/previmrc'
alias eb='exec bash '
...
sudo bash <(curl -s https://raw.githubusercontent.com/haquocdat543/Terraform/main/bash/vimconfig.sh)
